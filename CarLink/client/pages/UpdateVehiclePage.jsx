...
//       try {
//         const response = await fetch(`http://localhost:3000/owner/car/${carID}`, {
//           method: "GET",
//           headers: {
...
//         setCar(carData);
//         setUpdatedCar({
//           model: carData?.overview.model,
//           pricePerDay: carData?.overview.pricePerDay,
//           address: carData?.overview.address,
//           description: carData?.overview.description,
//         });
//       } catch (error) {
...
//   const [car, setCar] = useState(null);
//   const [updatedCar, setUpdatedCar] = useState({});
//   const [selectedFile, setSelectedFile] = useState(null); // State cho ảnh được chọn
...
//       if (selectedFile) {
//         formData.append("carImages[]", selectedFile);
//       }
        ...
        <div>
          ...
          <div className="preview-media">
            {previewMedia.map((media, index) => (
              media.type === "image" ? (
                <img key={index} src={media.url} alt={`Preview ${index + 1}`} className="preview-image" />
              ) : (
                <video key={index} controls src={media.url} className="preview-video" />
              )
            ))}
          </div>
        </div>
